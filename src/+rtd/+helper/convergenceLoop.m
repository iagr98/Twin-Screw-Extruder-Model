function convergenceLoop(extruder, c, M_w, w_p, m_sol, time, N_tot, plot_step)
    tol = 1e-2; 
    max_iter = 10; 
    diff = inf; 
    iter = 0;
    ...
    while diff > tol && iter < max_iter
        ...
        [t, m_sol] = rtd.CSTR_flow(extruder, m_0, T_0, [0 time], N_tot, plot_step, Reaction_data);
        [c, M_w, w_p] = rtd.CSTR_Reaction(extruder,c_0, [0 1000]);
        m_1 = m_sol(end,1:2:end);
        T_1 = m_sol(end,2:2:end);
        c_1 = c(end,:);
