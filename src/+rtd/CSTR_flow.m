...
options = odeset('OutputFcn',@(t,y,flag) OutFcn(t,y,flag,plot_step),'NonNegative',1:length(y0),...
    'RelTol',1e-5,'AbsTol',1e-7,'Events',@stationaryEvent);
...
function status = OutFcn(t,~,flag,plot_step)
global e
